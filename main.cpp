...
void Foo_second(Main<double> *p)
{
    ...
    double* arr_2 = new double[n + 1]; // коэффициенты многочлена
    cout << "Теперь вводим коэффициенты через пробел:\n";
    for (int i = 0; i <= 1; i++) cin >> arr_2[i]; // вводит коэффициенты с терминала
    
    Second mnogochlen(1, arr_2);
    p = &mnogochlen;
    cout << "Создание многочлена завершено\n";
